...
using System;
using System.Collections.Generic; // need using statement to declare lists
using System.Linq;
using System.Text;
...
{
    public class ProgramUI // Class needs to be public
    {
        private PokemonRepository _repo = new PokemonRepository(); // '_Repo' -> '_repo' | changed to match all the references to it
        public void Run()
        {
            SeedPokemonTeam();
        }
        ...
        private void AddPokemonToTeam()
        {
            ...
            else
            {
                ...
                string pokeLevel = Console.ReadLine(); // finished line {added 'Console.Readline()'}
                ...
                else
                {
                    ...
                    Pokemon newPokemon = new Pokemon(species, name, level, typeOne, typeTwo, moveOne, moveTwo, moveThree, moveFour); // added 'moveTwo'
        ...
        private void UpdateAPokemon(int teamPosition) // needed a type for teamPosition
        {
